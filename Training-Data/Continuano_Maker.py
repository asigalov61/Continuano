...
get_ipython().system("wget 'https://github.com/asigalov61/Tegridy-MIDI-Dataset/raw/master/Tegridy-MIDI-Dataset-CC-BY-NC-SA.zip'")
get_ipython().system("unzip -j '/notebooks/Dataset/Tegridy-MIDI-Dataset-CC-BY-NC-SA.zip'")
get_ipython().system("rm '/notebooks/Dataset/Tegridy-MIDI-Dataset-CC-BY-NC-SA.zip'")
